...
6. Validar no tablet da mesma loja a exibição de um QR Code gerado há menos de 30 minutos e o aviso de falha caso a API não possa carregar a fila. Consumo baixo.
