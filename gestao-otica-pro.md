...
6. Publicar a rota própria da maquininha no tablet e validar o PIN, a permanência da tela e a exibição de um QR Code gerado há menos de 30 minutos, além do aviso de falha caso a API não possa carregar a fila. Consumo baixo.
